...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { content: @reference.content, referable_id: @reference.referable_id, referable_type: @reference.referable_type, user_id: @reference.user_id }
    end
  ...
  test "should update reference" do
    put :update, id: @reference, reference: { content: @reference.content, referable_id: @reference.referable_id, referable_type: @reference.referable_type, user_id: @reference.user_id }
    assert_redirected_to reference_path(assigns(:reference))
  end
