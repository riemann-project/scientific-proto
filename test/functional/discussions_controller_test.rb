...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { content: @discussion.content, discussable_id: @discussion.discussable_id, discussable_type: @discussion.discussable_type, user_id: @discussion.user_id }
    end
  ...
  test "should update discussion" do
    put :update, id: @discussion, discussion: { content: @discussion.content, discussable_id: @discussion.discussable_id, discussable_type: @discussion.discussable_type, user_id: @discussion.user_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
